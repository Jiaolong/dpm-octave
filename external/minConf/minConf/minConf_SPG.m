...
t = t/2;
        ...
        elseif lineSearchIters < 2 || ~isLegal(f_prev)
            if verbose == 3
                fprintf_flush('Quadratic Backtracking\n');
            end
            t = polyinterp([0 f gtd; t f_new sqrt(-1)]);
        else
            if verbose == 3
                fprintf_flush('Cubic Backtracking on Function Values\n');
            end
